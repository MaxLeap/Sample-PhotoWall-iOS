//
//  PWImageDisplayViewController.m
//  MaxLeap
//
...
} PWImageViewControllerStartingInfo;




@implementation PWImageInfo
...
@interface PWImageViewController ()
<UIScrollViewDelegate,
UIGestureRecognizerDelegate
>

@property (nonatomic) PWImageViewControllerStartingInfo startingInfo;
@property (nonatomic, strong) PWImageInfo *imageInfo;
...
@implementation PWImageViewController

+ (void)displayWithImageInfo:(PWImageInfo *)imageInfo fromViewController:(UIViewController *)viewController {
    PWImageViewController *vc = [[PWImageViewController alloc] initWithImageInfo:imageInfo];
    if (viewController) {
...
- (instancetype)initWithImageInfo:(PWImageInfo *)imageInfo {
    if (self = [super init]) {
